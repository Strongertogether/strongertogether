...
class userDAO {
    ...
    public function create_user_DAO($db, $arrArgument) {
        ...
        /*
			$sql = "INSERT INTO users (name, surname, id_document, phone, email, password, "
			. "repeat_password, internet, art, technology, literature, music, other, male, female,"
			. " undefined, date_birthday, pais, provincia, poblacion, avatar) VALUES ('$name', '$surname', "
      . "'$id_document', '$phone', '$email', '$password', '$repeat_password', '$internet', '$art' "
			. "'$technology', '$literature', '$music', '$other', '$male', '$female', '$undefined', "
			. "'$date_birthday', '$pais', '$provincia', '$poblacion', '$avatar')";
*/
